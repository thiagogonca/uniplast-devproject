		...
		<?php
			...
			//O arquivo passou todas as verificações, hora de tentar move-lo para a pasta foto
				...
				if(move_uploaded_file($_FILES['arquivo']['tmp_name'], $_UP['pasta'].$nome_final)){
					$query = mysql_query("UPDATE produtos SET IMAGEM = '$nome_final' WHERE CD_PRODUTO = '$cod'");
				?>
					<h3 style="margin-left:2%;">Imagem Alterada com Sucesso</h3>
					<a href="editar_cadastro.php?id=<?php echo $cod ?>" class="btn btn-primary" style="margin-left:2%;">Voltar para Alteração</a>
				...
				?>
					<h3>Houve um Erro em Alterar a Imagem</h3>
					<a href="editar_imagem.php?id=<?php echo $cod ?>" class="btn btn-primary">Tentar Novamente</a>
				<?php
